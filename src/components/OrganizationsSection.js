    ...
    <section id="organizations" className="py-20 relative max-w-4xl mx-auto px-6">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
          Pengalaman <span className="bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">Organisasi</span>
        </h2>
      ...
      <div className="relative border-l border-zinc-800 ml-4 md:ml-32 pl-8 md:pl-12 space-y-12">
        {organizations.map((org, idx) => (
          ...
          >
            {/* Timeline dot */}
            <div className="absolute -left-[41px] md:-left-[57px] top-1.5 w-6 h-6 rounded-full bg-zinc-950 border-2 border-indigo-500 flex items-center justify-center shadow-lg shadow-indigo-500/20">
            ...
            <div className="glass-panel rounded-2xl p-6 relative overflow-hidden">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-4">
                <div>
                  ...
                  <p className="text-indigo-400 font-semibold text-sm">{org.organization}</p>
                </div>
